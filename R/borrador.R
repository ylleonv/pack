...
# ))
# A98seste_2$`Log-likelihood`
#
# (A98seste_3 <- dist3$GLMref_ec(
#   response = "choice", actual_response = "mode",
#   individuals = "indv",
#   explanatory_complete = c("intercept", "hinc", "psize"),
#   depend_y = c("gc", "ttme"),
#   distribution = "logistic", categories_order = c("bus", "train", "car", "air"), dataframe = travel.long88
# ))
# A98seste_3$`Log-likelihood`
#
# (A98seste_3 <- dist3$GLMref_ec(
#   response = "choice", actual_response = "mode",
#   individuals = "indv",
...
# ))
#
# A98seste$`Log-likelihood`
#
# A98seste$Coefficients
#
# (A98 <- dist3$GLMref_ec(
#   response = "choice", actual_response = "mode",
#   individuals = "indv",
#   explanatory_complete = c("intercept", "hinc", "psize"),
#   depend_y = c("gc", "invt"),
#   distribution = "logistic", categories_order = c("air", "bus", "train", "car"), dataframe = travel.long88
# ))
#
#
#
